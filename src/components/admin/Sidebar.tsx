...
const navGroups: NavGroup[] = [
      ...
      },
      {
        ...
        icon: (
          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
            <path d="M21.94 4.6l-3.32 15.66c-.25 1.1-.9 1.38-1.83.86l-5.05-3.72-2.44 2.35c-.27.27-.5.5-1.02.5l.36-5.15L17.4 6.6c.41-.36-.09-.56-.63-.2L7.18 12.6l-5-1.57c-1.09-.34-1.11-1.09.23-1.61l19.55-7.53c.9-.33 1.69.22 1.39 1.6-.01-.01.01.07-.41 1.11z"/>
          </svg>
        ),
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        label: 'Landing Xây Kênh AI',
        href: '/admin/xaykenhai',
        icon: (
          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
  ...
  return (
    <aside className="flex h-full w-60 shrink-0 flex-col bg-slate-900">
      ...
      <div className="flex h-16 items-center gap-3 px-5 border-b border-slate-800">
        ...
        <span className="text-sm font-bold text-white tracking-wide">MKT Software CMS</span>
      </div>
