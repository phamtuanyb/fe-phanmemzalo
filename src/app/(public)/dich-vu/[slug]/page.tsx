...
import StickyBottomBar from '@/app/(public)/xaykenh/[slug]/_components/StickyBottomBar'
import TestimonialsCarousel from '@/app/(public)/xaykenh/[slug]/_components/TestimonialsCarousel'
...
// Trang sản phẩm dịch vụ: dùng ISR — cache 5 phút, tự rebuild khi data đổi.
        ...
        <section className="py-14 bg-vs-bg">
          <div className="max-w-8xl mx-auto px-6">
            <h2 className="text-center text-[20px] sm:text-[24px] font-extrabold text-vs-dark mb-8">
              Các dịch vụ khác của MKT Software
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {related.map((p) => (
